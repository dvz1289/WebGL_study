...
const wallAmbientOcculusionTexture = textureLoader.load('/textures/bricks/ambientOcclusion.jpg')
...
const walls = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        aoMap: wallAmbientOcculusionTexture,
...
// scene.add(ghost1CameraHelper, ghost2CameraHelper, ghost3CameraHelper)
...
const tick = () =>
{
    ...
    ghost3.position.y = Math.sin(elapsedTime * 6) + Math.sin(elapsedTime * 0.5)
